...
import { deploy } from "../../private/deploy.js";
import validateDeploy from "../../private/validateDeploy.js";
...
router.post("/:name/:secret", async function (req, res, next) {
  try {
    ...
    deploy(req.params.name).on("stop", (data) =>
      respondTo(data, req.body.callback_url)
    );
