...
import ConfigureView from "./configure.js";
import StatusView from "./index.js";
import SpiritMenu from "./menu.js";
    ...
    layout(
      ...
      <StatusView
        ...
        controls={{
          ...
          canStart:
            state == "stopped" && latestLife && !!(await latestLife.container),
...
router.get("/:name/settings", async function (req, res, next) {
  ...
  return res.send(
    layout(
      ...
      <SettingsView name={name} mainInfo={settings} webhook={settings} />
    )
  );
});
